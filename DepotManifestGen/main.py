...
parser.add_argument('-u', '--username', required=True, default='fnkmar75584')
parser.add_argument('-p', '--password', required=False, default='MhBnKzT5a0')
parser.add_argument('-a', '--app-id', required=False, default='271590')
